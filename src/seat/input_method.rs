...
mod test {
    ...
    fn assert_is_manager_delegate<T>()
        where T: wayland_client::Dispatch<crate::reexports::protocols_misc::zwp_input_method_v2::client::zwp_input_method_manager_v2::ZwpInputMethodManagerV2, crate::globals::GlobalData>,
    {
    }

    fn assert_is_delegate<T>()
        where T: wayland_client::Dispatch<crate::reexports::protocols_misc::zwp_input_method_v2::client::zwp_input_method_v2::ZwpInputMethodV2, InputMethodData>,
    {
    }
